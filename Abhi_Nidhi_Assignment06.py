...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 16 10:59:31 2021
...
tf.compat.v1.disable_eager_execution() #using this for fastest performance
...
#To make run time in GPU format 
...
class Actor_Model:
    def __init__(self, input_shape, action_space, lr, optimizer):
        ...
        X = Dense(500, activation="relu", kernel_initializer=tf.random_normal_initializer(stddev=0.01))(X_input)
        X = Dense(300, activation="relu", kernel_initializer=tf.random_normal_initializer(stddev=0.01))(X)
        X = Dense(70, activation="relu", kernel_initializer=tf.random_normal_initializer(stddev=0.01))(X)
...
class Critic_Model:
    def __init__(self, input_shape, action_space, lr, optimizer):
        ...
        V = Dense(500, activation="relu", kernel_initializer='he_uniform')(X_input)
        V = Dense(300, activation="relu", kernel_initializer='he_uniform')(V)
        V = Dense(70, activation="relu", kernel_initializer='he_uniform')(V)
